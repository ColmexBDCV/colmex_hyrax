...
module Blacklight::FacetsHelperBehavior
  ...
  def render_facet_value(facet_field, item, options ={})
    ...
    content_tag(:span, :class => "facet-label") do
      link_to_unless(options[:suppress_link], t('blacklight.search.fields.facet.content.'+facet_display_value(facet_field, item), :default => facet_display_value(facet_field, item)), path, :class=>"facet_select")
