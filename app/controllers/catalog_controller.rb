class CatalogController < ApplicationController
  ...
  configure_blacklight do |config|
    ...
    config.add_index_field solr_name("is_performer_agent_of", :stored_searchable)
    config.add_index_field solr_name("is_instrumentalist_agent_of", :stored_searchable)
    config.add_index_field solr_name("is_singer_agent_of", :stored_searchable)
    ...
    config.add_index_field solr_name("is_finding_aid_for", :stored_searchable), helper_method: :convert_to_link
