  ...
  module WorksControllerBehavior
    ...
    private
      ...
      def after_update_response
        ...
        respond_to do |wants|
          wants.html { redirect_to [main_app, curation_concern], notice: t('hyrax.my.works.work') + " \"#{curation_concern}\" " + t('hyrax.my.works.successfully_updated') }
      ...
      def after_destroy_response(title)
        respond_to do |wants|
          wants.html { redirect_to my_works_path, notice: t('hyrax.my.works.deleted') + " #{title}" }
          wants.json { render_json_response(response_type: :deleted, message: t('hyrax.my.works.deleted') + " #{curation_concern.id}") }
        end
      end
