module Hyrax
  class WorkShowPresenter
   ...
   delegate :title, :alternate_title, :other_title, :date_created, :description, :creator, :subject_uniform_title,
             ...
             :has_transformation_by_genre, :is_transformation_by_genre, :is_person_member_of_collective_agent,
             :has_person_member_of_collective_agent, :has_carrier_type, to: :solr_document
