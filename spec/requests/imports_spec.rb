...
RSpec.describe "/imports", type: :request do
  # Este bloque before se ejecuta antes de cada prueba dentro de este describe
  before do
    # Aquí creamos un usuario sin validar para las pruebas
    user_attributes = { email: 'test@example.com' }
    user = User.new(user_attributes) { |u| u.save(validate: false) }

    # Aquí inicia sesión el usuario creado anteriormente
