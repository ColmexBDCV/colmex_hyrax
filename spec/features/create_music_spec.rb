...
RSpec.feature 'Create a Music', js: true do
  context 'a logged in user' do
    ...
    scenario do
      ...
      choose "payload_concern", option: "Music"
      ...
      fill_in('Title', with: 'My Test Music')
      ...
      expect(page).to have_content('My Test Music')
