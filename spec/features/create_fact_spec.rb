...
RSpec.feature 'Create a Fact', js: true do
  context 'a logged in user' do
    ...
    scenario do
      ...
      choose "payload_concern", option: "Fact"
      click_button "Create work"
      
      expect(page).to have_content "Add New Fact"
      ...
      fill_in('Title', with: 'My Test Fact')
