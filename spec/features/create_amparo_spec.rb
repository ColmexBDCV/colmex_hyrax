...
RSpec.feature 'Create a Amparo', js: true do
  context 'a logged in user' do
    ...
    scenario do
      ...
      choose "payload_concern", option: "Amparo"
      click_button "Create work"
      
      expect(page).to have_content "Add New Amparo"
      ...
      fill_in('Title', with: 'My Test Amparo')
