...
RSpec.feature 'Create a Map', js: true do
  context 'a logged in user' do
    ...
    scenario do
      ...
      choose "payload_concern", option: "Map"
      ...
      fill_in('Title', with: 'My Test Map')
      ...
      expect(page).to have_content('My Test Map')
