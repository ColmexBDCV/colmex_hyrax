Hyrax.config do |config|
  ...
  # Injected via `rails g hyrax:work Legaslation`
  config.register_curation_concern :legaslation
  ...
  config.analytic_start_date = DateTime.new(2017, 9, 1)
  ...
  config.banner_image = '/img/banner.png'
